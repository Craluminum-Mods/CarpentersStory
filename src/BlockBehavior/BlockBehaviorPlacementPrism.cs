...
{
    public class BlockBehaviorPlacementPrism : BlockBehavior
    {
        JsonItemStack drop;

        public BlockBehaviorPlacementPrism(Block block) : base(block) { }
        ...
        public override bool TryPlaceBlock(IWorldAccessor world, IPlayer byPlayer, ItemStack itemstack, BlockSelection blockSel, ref EnumHandling handling, ref string failureCode)
        {
            ...
            var orientedBlock = block.RotatedPrism(byPlayer, blockSel);
