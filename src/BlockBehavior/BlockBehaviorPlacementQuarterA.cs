...
{
    /// <summary>
    /// For symmetric angled blocks
    /// </summary>
    public class BlockBehaviorPlacementQuarterA : BlockBehavior
    {
        JsonItemStack drop;

        public BlockBehaviorPlacementQuarterA(Block block) : base(block) { }
        ...
        public override bool TryPlaceBlock(IWorldAccessor world, IPlayer byPlayer, ItemStack itemstack, BlockSelection blockSel, ref EnumHandling handling, ref string failureCode)
        {
            ...
            var orientedBlock = block.RotatedByQuarterA(byPlayer, blockSel);
