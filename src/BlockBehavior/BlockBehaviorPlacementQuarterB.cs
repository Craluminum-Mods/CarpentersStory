...
{
    /// <summary>
    /// Each quarter has its own variant
    /// </summary>
    public class BlockBehaviorPlacementQuarterB : BlockBehavior
    {
        JsonItemStack drop;

        public BlockBehaviorPlacementQuarterB(Block block) : base(block) { }
        ...
        public override bool TryPlaceBlock(IWorldAccessor world, IPlayer byPlayer, ItemStack itemstack, BlockSelection blockSel, ref EnumHandling handling, ref string failureCode)
        {
            ...
            var orientedBlock = block.RotatedByQuarterB(byPlayer, blockSel);
